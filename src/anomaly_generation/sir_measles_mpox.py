...
class MeaslesSIRAnomalyGenerator(BaseAnomalyGenerator):
    ...
    def _calculate_reported_symptoms(self, compartments: Dict[str, np.ndarray]) -> Dict[str, np.ndarray]:
        ...
        return {  
            ...
            'Rash_-_adult': symptom_probs['rash']['adults'] * 0.8*(I2a + I3a),
            'Rash_-_children': symptom_probs['rash']['children'] *0.2* (I2a + I3a),
            'Skin_change': symptom_probs['Skin_change'] * (I3a),
            'Leg_and_foot_ulcers': symptom_probs['Leg_and_foot_ulcers'] * (I3a)
        }
